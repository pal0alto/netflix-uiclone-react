...
const SavedShows = () => {
  ...
  return (
    <>
        <h2 className='text-white font-bold md:text-xl p-4'>Favourite Productions</h2>
        <div className='relative flex items-center group'>
            ...
            {movies.map((item, id) => (
                        <div key={id} className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2'>
                               ...
                               <div className='absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 hover:opacity-75 text-white'>
                                    <p className='white-space-normal text-xs md:text-sm font-bold h-full flex justify-center items-center text-center'>{item?.title}</p>
